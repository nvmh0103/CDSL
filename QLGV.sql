...
CREATE TABLE GIANGDAY(
    ...
    CONSTRAINT FK_MALOP2 FOREIGN KEY (MALOP) REFERENCES LOP(MALOP),
...
CREATE TABLE KETQUATHI(
    ...
    CONSTRAINT FK_MAHV1 FOREIGN KEY (MAHV) REFERENCES HOCVIEN(MAHV),
...
WHERE HOCVIEN.MAHV=KETQUATHI.MAHV AND KETQUATHI.MAMH='CTRR' AND HOCVIEN.MALOP='K12'
ORDER BY HO,TEN
--CAU 3
SELECT DISTINCT HOCVIEN.MAHV,HO,TEN,MAMH
FROM HOCVIEN,KETQUATHI
WHERE HOCVIEN.MAHV=KETQUATHI.MAHV AND LANTHI=1 AND KQUA='DAT'

--CAU 4
SELECT HOCVIEN.MAHV,HO,TEN
FROM HOCVIEN,KETQUATHI
WHERE HOCVIEN.MAHV=KETQUATHI.MAHV AND MALOP='K11' AND MAMH='CTRR' AND LANTHI=1 AND KQUA='Khong Dat'

-- CAU 5
SELECT DISTINCT HOCVIEN.MAHV,HO,TEN 
FROM HOCVIEN,KETQUATHI
WHERE MAMH='CTRR' AND HOCVIEN.MAHV=KETQUATHI.MAHV AND HOCVIEN.MAHV NOT IN (
    SELECT MAHV
    FROM KETQUATHI
    WHERE KQUA='DAU' AND MAMH='CTRR'
)
--CAU 6
