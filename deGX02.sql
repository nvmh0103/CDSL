...
--CAU 6
SELECT TOP 1 TANG,COUNT(SODK) AS SOLUONGGUI
FROM GUIXE,VITRI
...
WHERE DANGKY.MATV=THANHVIEN.MATV AND THANHVIEN.LOAITV='THUONG' 
INTERSECT
SELECT MONTH(NGDK)
FROM DANGKY,THANHVIEN
WHERE DANGKY.MATV=THANHVIEN.MATV AND THANHVIEN.LOAITV='NGAN HAN' 
